...
REG_NEWS = {
    ...
    "PPWR 포장재": '"PPWR" OR "EU packaging and packaging waste regulation"',
    "ESPR 에코디자인": '"ESPR" OR "ecodesign for sustainable products" OR "digital product passport"',
    "ELV 폐차·순환": '"end-of-life vehicles regulation" OR "ELV regulation" EU circularity',
    "재생에너지 RED": '"renewable energy directive" OR "RED III" EU',
...
TAGS = {
    ...
    "PPWR 포장재": r"\bppwr\b|packaging and packaging waste|packaging regulation",
    "ESPR 에코디자인": r"\bespr\b|ecodesign|eco-design|digital product passport",
    "ELV 폐차·순환": r"end.?of.?life vehicle|\belv regulation\b|vehicle circularity",
    "재생에너지 RED": r"renewable energy directive|\bred ii\b|\bred iii\b|rfnbo",
